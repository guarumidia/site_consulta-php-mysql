...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-7 col-md-8 col-sm-8 col-12" id="capa-dir">
            <h1><span id="nome">PAINEL </span><span id="projeto">ADMINISTRATIVO</span></h1>
            <form  name="voltar" method="post" action="cadastrar_graduacao.php">
                <input type="submit" name="conheca" value="CADASTRAR GRADUAÇÃO" id="btn-adm">
            </form>
            <br>
            <form  name="voltar" method="post" action="cadastrar_extensao.php">
                <input type="submit" name="conheca" value="CADASTRAR EXTENSÃO" id="btn-adm">
            </form>
            <br>
            <form  name="voltar" method="post" action="cadastrar_pesquisa.php">
                <input type="submit" name="conheca" value="CADASTRAR PESQUISA" id="btn-adm">
            </form>
        </div>
    </div>
</div>
