...
<head>
    ...
    <title>Cadastrar curso de extensão</title>
...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-7 col-md-8 col-sm-8 col-12" id="capa-dir">
            ...
            <h1><span id="nome">CADASTRAR </span><span id="projeto">EXTENSÃO</span></h1>

<form method="post" action="processar_extensao.php">
    ...
    <textarea type="text" class="form-control" name="descricao" rows="3" placeholder="Digite a descrição da extensão..."></textarea>
    <br>
