...
<div class="row mt-4">
    ...
    <div class="col-lg-7 col-md-8 col-sm-8 col-12" id="capa-dir">
        <h1><span id="nome">SOBRE O </span><span id="projeto">PROJETO</span></h1>
        <p class="text-justify">TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO TEXTO</p>
        <form  name="voltar" method="post" action="#">
            <input type="submit" name="conheca" value="CONHEÇA" id="btn-conheca">
        </form>
    </div>
</div>
</div>
