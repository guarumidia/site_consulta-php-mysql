...
<head>
    ...
    <title>Cadastrar curso de pesquisa</title>
...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-7 col-md-8 col-sm-8 col-12" id="capa-dir">
            ...
            <h1><span id="nome">CADASTRAR </span><span id="projeto">PESQUISA</span></h1>

<form method="post" action="processar_pesquisa.php">
    ...
    <input type="text" class="form-control" name="projeto_pesquisa" placeholder="Digite o Projeto de pesquisa...">
    <br>

    <input type="text" class="form-control" name="data_inicio" placeholder="Digite a data de início...">
    <br>

    <textarea type="text" class="form-control" name="descricao" rows="3" placeholder="Digite a descrição da pesquisa..."></textarea>
    <br>

    <input type="text" class="form-control" name="docente" placeholder="Digite o nome do Docente responsável...">
    <br>
