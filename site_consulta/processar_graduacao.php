...
$grandearea2 = $_POST['grandearea2'];
$grandearea3 = $_POST['grandearea3'];
$area = $_POST['area'];
$area2 = $_POST['area2'];
$area3 = $_POST['area3'];
...
$centro = $_POST['centro'];
$campus = $_POST['campus'];
$versao_curricular = $_POST['versao_curricular'];
$codigo_disciplina = $_POST['codigo_disciplina'];
$nome_disciplina = $_POST['nome_disciplina'];
$tipo = $_POST['tipo'];
$periodo = $_POST['periodo'];
$creditos = $_POST['creditos'];
$horaria_teorica = $_POST['horaria_teorica'];
$horaria_pratica = $_POST['horaria_pratica'];
$horaria_extensao = $_POST['horaria_extensao'];
$ementa = $_POST['ementa'];
$contato = $_POST['contato'];



$sql = "INSERT INTO graduacao VALUES ";
$sql .= "(DEFAULT, '$grandearea', '$grandearea2', '$grandearea3', '$area', '$area2', '$area3', '$deficiencia', '$deficiencia2', '$deficiencia3', '$deficiencia4', '$deficiencia5', '$deficiencia6', '$deficiencia7', '$deficiencia8', '$codigo_mec', '$codigo_siga', '$nome_curso', '$grau', '$modalidade', '$turno', '$unidade', '$centro', '$campus', '$versao_curricular', '$codigo_disciplina', '$nome_disciplina', '$tipo', '$periodo', '$creditos', '$horaria_teorica', '$horaria_pratica', '$horaria_extensao', '$ementa', '$contato')";
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-7 col-md-8 col-sm-8 col-12" id="capa-dir">
            ...
            <div class="alert alert-success" role="alert">
                <?php
                echo "$nome_curso, foi cadastrado com sucesso!";
                ?>
            </div>
